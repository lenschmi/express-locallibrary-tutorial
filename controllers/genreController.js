...
// Note that this is an array of middleware functions
// The array is passed to the router function and each method is called in order
// This is needed because the validators are middleware functions
exports.genre_create_post =  [

    // Validate and santize the name field.
    // Specifies the validators
    body('name', 'Genre name required').trim().isLength({ min: 1 }).escape(),
  
    // Process request after validation and sanitization.
    // Middleware function to extract any validation errors
    (req, res, next) => {
